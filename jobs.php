...
<head>
  ...
  <title> brouva | Job Listings </title>
...
<body onload="logoBeat()" style="font-family: 'Libre Baskerville', serif;">
      ...
      <div style="width: 100%" class="row">
        <div class="col-md-9">
          ...
          <div class="container" style="padding-left:50px; padding-top:50px; padding-bottom:50px;">
            ...
            ?>
                <h3 style="font-family: 'Libre Baskerville', cursive; font-family: 'Libre Baskerville', serif; color: #f2cc8f; padding-left:4px;"> Total Job Posts Available: <?php echo $numberofposts; ?> </h3>
            <?php }
            } ?>
            ...
            ?>
                <h3 style="font-family: 'Libre Baskerville', cursive; font-family: 'Libre Baskerville', serif; color: #f2cc8f; padding-left:4px;"> Active Users: <?php echo $numberofusers; ?> </h3>
            <?php }
            } ?>
            <!--------------------------------------------------------------------------------------------->
