...
<meta charset="utf-8">
    ...
    <!-- Your existing CSS and JavaScript links -->
    ...
    <style>
        ...
        .btnTilt { height: 75px; background: rgba(225, 225, 225, 0.2); color: white; font-family: Libre Baskerville; }
        .textDarkShadow { text-shadow: 0px 0px 3px #000, 3px 3px 5px #003333; }
        /* Additional style to change text color to black */
        .section#about .card-body { color: #000; }
    </style>

<body onload="logoBeat()" style="font-family: 'Libre Baskerville', sans-serif;">
<?php
  include 'navBar.php';
...
<div class="page-content">
  <div>
    ...
    <button type="button" class="btn btn-info " data-toggle="modal" data-target="#uploadImage" style="margin-left: 23%;"> Update Profile Image</button>
